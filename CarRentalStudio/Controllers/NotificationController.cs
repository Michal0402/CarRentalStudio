...
namespace CarRentalStudio.Controllers
{
    public class NotificationController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Message,UserId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Message,UserId")] Notification notification)
        {
